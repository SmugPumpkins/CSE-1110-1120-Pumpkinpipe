...
The purpose of this challenge is to practice creating custom gesture recognition and gesture control.
...
* The top left corner displays the currently detected hand as "rock", "paper, "scissors", or "none" as text.
...
* When the timer ends, have the program display a picture of rock, paper or scissors to represent it's secret choice before showing the game's results.
