...
The purpose of this challenge is to practice with different styling options that can be applied to the hand drawing.
...
* Hands are detected.
* Hands are drawn.
* Each individual landmark has its color change based on the y positoin of that specific landmark. 
    * For example, for a lower y position they might be more green, and for a higher y position they might be more red.
* Each individual landmark has its thickness change based on the z position of that specifc landmark.
